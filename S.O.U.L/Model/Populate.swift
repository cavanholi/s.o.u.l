...
class Populate {
    ...
    func popSceneBase() -> [Int: Scene] {
        var scene = [Int: Scene]()
        scene[1] = Scene(index : 1, text : "The calm and refreshing breeze that accompanied you at the beginning of the journey had turn into a strong storm by the time the day ended.\nTo make matters worse, as the last ray of sun vanished and darkness surrounded you, you came to long and thin bridge.", path: ["Continue"], target : [1])
        scene[2] = Scene(index : 2, text : "Beneath the bridge, a deep chasm opened. If there were any river down there, it was impossible to know. Darkness had already settled and the howling wind made deafened any sound the river could make.\nYou remember a small village, just a few houses really, quite a long way back.", path: ["Cross the Bridge", "Return to the Village"], target : [2, 3])
        scene[3] = Scene(index : 3, text : "The wind is strong and the bridge swings madly with each step you take. You’re halfway now, turn around is no longer an option.", path: ["<i>There's no return now</i>", "/!/"], target : [8, 9], skill : "refl")
        scene[4] = Scene(index : 4, text : "To cross the bridge under this weather is madness. It is better to make your way back to the village.", path: ["Continue"], target: [15])
            scene[5] = Scene(index : 5, text : "Fearing the worst you throw your body against the wind.\nYou overdue it and fall to your knees, but you fall on safe and solid ground.\nAs you stand up you see a small path leading alongside the cliff.", path: ["Follow the Path"], target: [18])
        scene[6] = Scene(index : 6, text : "Two thirds of the way, you brave your way across.\nOne fifth left, almost there. \nAlmost there, almost.", path: ["/Snap!/"], target: [10])
        scene[7] = Scene(index : 7, text : "As you inch your way across the bridge, you become more and more uneasy about it.\nFor a brief moment you look back, you can barely see the start of it, and the end is so close.", path: ["/Snap!/"], target: [12])
        scene[8] = Scene(index : 8, text : "The sound barely made to your ears.\nAs the bridge disappeared under your feet, you tried keep hold of the railing, but the rotten hope gave way as you began the painful descent. \nAt least you will know if there is a river down there or not.", path: ["/death is just another Journey/"], target : [11])
        scene[9] = Scene(index : 9, text : "You barely heard the sound.\nBut your body acted before you could think and when you realise you were holding yourself on the precarious rope that once was the bridge railing.\nWith no time to think, you rush your way up.", path: ["/No time to think now/"], target : [13])
        scene[10] = Scene(index : 10, text : "With a racing heart and nearly breathless you made your way up to safety.\nYour body aches and and your hans are bleeding, but nothing matter now. \nThe road was firm ahead of you, solid ground. There shouldn’t be any more surprise until the end.", path: ["/the Journey continues/"], target : [14])
        scene[11] = Scene(index : 11, text : "On the next day, long after the storm had ended, you return to the bridge.\nIt lies broken, the rotten ropes had snapped with the wind force.\nYou consider yourself lucky, for it could have failed while you were crossing.", path: ["The Journey Ends"], target : [16])
        scene[12] = Scene( index : 12, text : "Sadly, there is no other way across. \nYour journey came to an end you didn’t expected.\nBut far from the be the worse finale.", path: ["/there is always a new Journey/"], target : [17])
        scene[13] = Scene(index : 13, text : "You follow the narrow path, so close to the chasm it is scary, but no sudden gust of wind hit you again and soon you found yourself walking away from it.\nAt the end, you see a small hut, it looks abandoned, there is no door. But it is a good enough place to spend the night, a far closer than the village.", path: ["Continue"], target : [19])
        scene[14] = Scene(index : 14, text : "The sun shines bright and the stormy wind turned back into a pleasant breeze by next morning.\nThe bridge is still there, still looking dangerous, but safe enough, if the wind hadn’t blow it away, you are quite sure it would hold yourself.", path: ["Cross the Bridge...", "/It is better to hold on..."], target : [20, 21], item : "Cursed Ring")
        scene[15] = Scene(index : 15, text : "With great care you inch your way across it. With the bridge swing with each step, each plank cracking under your feet.\nBut no bad surprises happen and you make your way across safely.\nThe next bridge you would have to cross, it will be a firm stone one at the end of your journey.", path: ["The journey continues"], target : [14])
        scene[16] = Scene(index : 16, text : "As you step ahead a sudden gust of wind make you almost tumble forward.", path: ["Continue..", "/Damn it!/"], target : [4, 5], skill : "sens")
        scene[17] = Scene(index : 17, text : "As you turn around a sudden gust of wind make you almost tumble backward.", path: ["Continue..", "/Oh Shit!/"], target : [6, 7], skill : "sens")
        scene[18] = Scene(index : 18, text : "You fiddle with the ring in your finger as you cross the bridge.\n /When did I put it on?/ You wonder about halfway. \nSo absorted you were, you didn't even heard the sound of the ropes snapping. The ring is the last thing in your thought as you fall to your death", path: ["death is just another Journey"], target : [11])
