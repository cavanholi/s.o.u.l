...
class Populate {
    ...
    func popSceneBase() -> [Int: Scene] {
        ...
        scene[13] = Scene(index : 13, text : "You follow the narrow path, so close to the chasm it is scary, but no sudden gust of wind hit you again and soon you found yourself walking away from it.\nAt the end, you see a small hut, it looks abandoned, there is no door. But it is a good enough place to spend the night, a far closer than the village.", path: ["Continue"], target : [14])
        scene[14] = Scene(index : 14, text : "The sun shines bright and the stormy wind turned back into a pleasant breeze by next morning.\nThe bridge is still there, still looking dangerous, but safe enough, if the wind hadn’t blow it away, you are quite sure it would hold yourself.", path: ["Cross the Bridge...", "/It is better to hold on..."], target : [15, 18], item : "Cursed Ring")
